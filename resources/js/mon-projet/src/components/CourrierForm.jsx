      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl h-full max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-3">
             ...
             <div>
               <h2 className="text-base font-bold text-slate-900">Nouveau Courrier {type === 'entrant' ? 'Arrivé' : 'Départ'}</h2>
               <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Circuit hiérarchique</p>
             </div>
          </div>
